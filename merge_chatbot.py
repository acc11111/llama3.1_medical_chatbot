...
with st.sidebar:
    st.markdown("## 医疗对话机器人")
    "[测试](https://github.com/datawhalechina/self-llm.git)"
...
lora_path = '/root/autodl-tmp/output/llama3_1_instruct_lora/checkpoint-33318' #lora的checkpoint路径
...
if prompt := st.chat_input():
    ...
    st.chat_message("user",avatar="patient.jpg").write(prompt)
    ...
    # 在聊天界面上显示模型的输出
    st.chat_message("assistant",avatar="doctor.png").write(response)
