...
if __name__ == "__main__":
    ...
    # 将JSON文件转换为CSV文件
    df = pd.read_json('/root/autodl-tmp/datasets/transformed_data.json',encoding='utf-8')
    ...
    trainer.train("/root/autodl-tmp/output/llama3_1_instruct_lora/checkpoint-16900") # 开始训练 
